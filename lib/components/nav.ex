defmodule Material.Component.Nav do
  ...
  def init(current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"Sensor", Material.Scene.Sensor},
           {"Sensor (spec)", Material.Scene.SensorSpec},
           {"Primitives", Material.Scene.Primitives},
           {"Components", Material.Scene.Components},
           {"Transforms", Material.Scene.Transforms}
         ], current_scene},
        id: :nav,
        translate: {70, 15}
      )
